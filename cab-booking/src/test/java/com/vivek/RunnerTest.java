...
import com.vivek.controllers.CabsController;
import com.vivek.controllers.RidersController;
...
import com.vivek.strategies.DefaultCabMatchingStrategy;
...
public class RunnerTest {
  ...
  void setUp() {
    ...
    TripsManager tripsManager = new TripsManager(cabsManager, cabMatchingStrategy);
  ...
  void testCabBookingFlow() {
    ...
    System.out.println(ridersController.fetchTripHistory(r1));
    System.out.println(ridersController.fetchTripHistory(r2));
...
//    });
    ...
    System.out.println(ridersController.fetchTripHistory(r1));
    System.out.println(ridersController.fetchTripHistory(r2));
    System.out.println(ridersController.fetchTripHistory(r4));
